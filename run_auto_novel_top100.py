...
def main():
    ...
    # 所以我们用shell方式运行整个命令
    command = f"source {venv_dir} && cd {spider_dir} && scrapy crawl auto_novel_top100 -a local=1"
    # command = f"source {venv_dir} && cd {spider_dir} && scrapy crawl auto_novel_top100"
